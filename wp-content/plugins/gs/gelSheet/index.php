...
<head>
    ...
    <style type="text/css" media="screen">
	    ...
	    @import url("./themes/extjs/css/ext-all.css");
    </style>
	...
	<script type="text/javascript" src="client/dev/extjs/adapter/ext/ext-base.js"></script>
	<script type="text/javascript" src="client/dev/extjs/ext-all.js"></script>
...
//    $cnf['jspath'][] = "../extjs/ext-all.js"; 
    ...
    $cnf['jspath'][] ="./client/dev/comm/comm_manager.js";
   	...
   	$cnf['jspath'][] ="./client/dev/application/openFile_dialogBox.js";
...
<body id="body" onload="setTimeout('load()',100);" >
