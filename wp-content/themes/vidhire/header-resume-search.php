	...
	<form action="<?php echo esc_url( home_url() ); ?>/" method="get" id="searchform">
		...
		<div class="search-wrap">
			...
			<div>
				...
				<!--
        <input type="text" id="near" title="<?php _e('Search Jobs by Location',APP_TD); ?>" name="location" class="text" placeholder="<?php _e('Search Jobs by Location',APP_TD); ?>" value="<?php if (isset($_GET['location'])) echo esc_attr($_GET['location']); ?>" />-->
