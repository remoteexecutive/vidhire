...
$options_integration = array (
	...
	array(
		'name' => __('Channel Name', APP_TD),
        'desc' 		=> __( 'If you add a channel name you can monitor site performance in your Indeed account.', APP_TD ),
		'tip' 		=> __('Enter a channel name for this site. This must match an existing channel on your Indeed account.',APP_TD),
		'id' 		=> $app_abbr.'_indeed_channel',
		'css' 		=> 'min-width:150px;',
		'type' 		=> 'text',
		'req' 		=> '',
		'min' 		=> '',
