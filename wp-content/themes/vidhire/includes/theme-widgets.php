...
?>
		...
		<ul style="padding: 0px 0 !important;">
...
class JR_Widget_Resume_Categories extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		$cat_args = array('orderby' => 'name', 'show_count' => 1, 'hierarchical' => $h, 'taxonomy' => 'resume_category', 'title_li' => '');
		
		echo '<ul class="resume_categories_ul">';
