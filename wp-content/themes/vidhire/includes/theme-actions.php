...
remove_action( 'appthemes_display_notice', array( 'APP_Notices', 'outputter' ), 10, 2 );
add_action( 'appthemes_display_notice', 'jr_display_notice', 10, 2 );
...
/**
 * custom outputter for displaying notices
 * @since 1.7.3
 */
function jr_display_notice( $class, $msgs ) {
?>
