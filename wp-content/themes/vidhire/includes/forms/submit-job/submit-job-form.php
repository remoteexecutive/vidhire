...
?>
    ...
    <fieldset>
    	  <legend><?php _e('Spreadsheet', APP_TD); ?></legend>
    
    <a class="add-spreadsheet-column">Add Column</a>
    <a class="add-spreadsheet-row">Add Row</a>  
    <a class="alert-table-data">Alert Table Data</a>
    <div style="overflow: hidden; text-overflow:ellipsis;">
    <table class="spreadsheet">
      <tbody>
      <tr>
        <td class="text" contenteditable="true">Row 1 Column 1</td>
        <td class="text" contenteditable="true">Row 1 Column 2</td>
        <td class="text" contenteditable="true">Row 1 Column 3</td>
        <td class="text" contenteditable="true">Row 1 Column 4</td>
      </tr>
      
      <tr>
        <td class="text" contenteditable="true">Row 2 Column 1</td>
        <td class="text" contenteditable="true">Row 2 Column 2</td>
        <td class="text" contenteditable="true">Row 2 Column 3</td>
        <td class="text" contenteditable="true">Row 2 Column 4</td>
      </tr>
      </tbody>  
    </table>
    </div>  
