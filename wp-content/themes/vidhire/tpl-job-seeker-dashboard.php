...
?>
	...
	<div class="section">
		...
		<div class="section_content">
			...
			<h1><?php printf( __('Job Seeker Dashboard - %s', APP_TD), ucwords( $userdata->user_login )); ?></h1>
			...
			<ul class="display_section">
				...
				<li><a href="#dashboard" class="noscroll"><?php _e('Jobs', APP_TD); ?></a></li>
				<li><a href="#resumes" class="noscroll"><?php _e('My Resumes', APP_TD); ?></a></li>
				...
				<table cellpadding="0" cellspacing="0" class="data_list">
					<thead>
						<tr>
							...
							<th class="center"><?php _e('Created',APP_TD); ?></th>
							<th class="center"><?php _e('Modified',APP_TD); ?></th>
