...
if ($resume_id > 0) {
    ...
    if ($current_user->ID == $resume_details->post_author || current_user_can('manage_options')) :

    // We have permission to edit this!

    else : redirect_myjobs();
    endif;
...
<div class="section">
    ...
    <div class="section_content">
        ...
        <h1><?php if ($editing) _e('Edit Resume', APP_TD);
else _e('Add Resume', APP_TD); ?></h1>
