            ...
            <div>
				...
				<ul class="section_footer" style="display:none;">
					...
					<?php if ($url = get_post_meta($post->ID, 'job_url', true)) : ?>
						<li class="apply"><a href="<?php echo $url; echo 'unregistered' ?>" <?php
					...
					?>	
          <li class="apply"><a href="#apply_form" class="apply_online"><?php _e('Apply',APP_TD); ?></a></li>
          <?php } else { ?>
          <li class="apply"><a href="http://singularityteam.com/11/login"><?php _e('Apply',APP_TD); ?></a></li>
          <?php } ?>
					<?php endif; ?>
